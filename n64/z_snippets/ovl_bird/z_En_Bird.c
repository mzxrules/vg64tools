...
/* Local functions */
extern void bird_func0x809C1BB0( struct z64_actor_t * a0, ZAFunc * a1 );
extern void bird_func0x809C1BB8( struct z64_actor_old_t * a0, u32 * a1 );
extern void bird_func0x809C1CA0( u32 * a0, u32 * a1);
extern void bird_func0x809C1CAC( struct z64_actor_old_t * a0, u16 a1 );
extern void bird_func0x809C1D60( struct z64_actor_old_t * a0, u32 * a1 );
extern void bird_func0x809C1E00( void * a0, u32 * actor_var);
extern void bird_func0x809C1E40( struct z64_actor_old_t * a0, u32 * a1 );
extern void bird_func0x809C1F5C( struct z64_actor_t * a0, u32 * a1 );
extern void bird_func0x809C1F8C( struct z64_actor_old_t * a, void * wut );
...
extern void func_8002B1E0( struct z64_actor_old_t *, u32, u32 a2 );
extern u32  func_800A2000( u32 animation );
extern void func_80077D90( int, int );
extern void func_800A51A0( struct z64_actor_old_t *, u32 animation, u32, f32, u32, u32, f32 );
extern f32  func_80100290( f32 );
extern void func_80078310( struct z64_actor_old_t *, f32, u32, f32, f32 );
...
{
    AVAL(a0,ZAFunc,0x190) = (ZAFunc)a1;
}
...
void bird_func0x809C1BB8( struct z64_actor_old_t * a0, u32 * a1 )
{
    ...
    func_8002B1E0(a0 + 0x00B4, 0x45ABE000, (u32)0x8003B5EC);
...
void bird_func0x809C1CAC( struct z64_actor_old_t * a0, u16 a1 )
{
    u32 v0;
    f32 f0;
    ...
    bird_func0x809C1BB0(a0, (ZAFunc)0x809C1D60); /* Local */
}
...
void bird_func0x809C1D60(struct z64_actor_old_t * a0, u32 * a1)
{
    ...
    a0->_0x00BC = a0->_0x00BC+(a0->v01A0 * f0);
